...
<body>
  ...
  <script type="text/html" id="toolbar_get_row_data">
    <a href="./operate/add_press.php" class="layui-btn layui-btn-sm">新增数据</a>


    <div class="layui-inline" id="search_title">
      <input class="layui-input search" name="yading_picihao" id="yading_picihao" placeholder="根据批次号搜索">
    </div>



    <div class="layui-inline" id="search_date_start">
      <input class="layui-input" name="date_start" id="date_start" placeholder="压锭日期(起始)">
    </div>
    <div class="layui-inline" id="search_date_start">
      <input class="layui-input" name="date_end" id="date_end" placeholder="压锭日期(结束)">
    </div>
    ...
    layui.use(
      ...
      function() {
        ...
        var inst = table.render({
          ...
          cols: [
            [
              ...
              {
                field: 'yading_tianbiaoren',
                title: '填表人',
                hide: true,
                edit: editable
              },
              {
                field: 'yading_canyuren',
                title: '参与人',
                hide: true,
                edit: editable
              },
              ...
              {
                field: 'yading_guige_1',
                title: '规格(前)',
                edit: editable,
                width: 120
              },
              {
                field: 'yading_zhongliang_1',
                title: '重量',
                edit: editable,
                width: 120
              },
              {
                field: 'yading_zhenkong_shijian',
                title: '抽真空时间',
                edit: editable,
                width: 120
              },
              {
                field: 'yading_zhenkongdu',
                title: '真空度',
                edit: editable,
                width: 120
              },
              {
                field: 'yading_mujuwendu',
                title: '模具温度',
                edit: editable,
                width: 120
              },
              {
                field: 'yading_zhidingyali',
                title: '制锭压力',
                edit: editable,
                width: 120
              },
              {
                field: 'yading_fending_zhongliang',
                title: '粉锭重量',
                edit: editable,
                width: 120
              },
          ...
          url: './action/table_getdata_press_action.php', // 后端数据接口
          page: true, // 是否显示分页
        ...
        document.getElementById('search').onclick = function() {
          var yading_picihao = document.getElementById('yading_picihao').value;
          var date_start = document.getElementById('date_start').value;
          var date_end = document.getElementById('date_end').value;

          table.reloadData('my_table', {
            url: './action/table_search_press_action.php' // 后端搜索接口
              ,
            where: {
              yading_picihao: yading_picihao,
        ...
        table.on('tool(my_table)', function(obj) {
          ...
          var data = obj.data;
          var php_id = data.id;
          var picihao_luhao = data.yading_picihao;
    ...
    id: 'del',
              ...
              click: function(data, othis) {
                ...
                //根据 id 做出不同操作
                  ...
                  /* if(data.id === 'view'){
                              window.location.href = './operate/report_view_press.php?id='+php_id;
                            }
                              else if(data.id === 'edit'){
                              window.location.href = './operate/report_edit_press.php?id='+php_id;
                            }
                              else */
                  if (data.id === 'del') {
                    layer.confirm('确定删除吗?', function(index) {
                      ...
                      $.ajax({
                        url: './action/del_row_press.php?id=' + php_id,
                        type: 'get',
                        dataType: "json",

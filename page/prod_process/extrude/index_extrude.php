...
<body>
  ...
  <script type="text/html" id="toolbar_get_row_data">
    <a href="./operate/add_extrude.php" class="layui-btn layui-btn-sm">新增数据</a>


    <div class="layui-inline" id="search_title">
      <input class="layui-input search" name="jichu_picihao" id="jichu_picihao" placeholder="根据批次号搜索">
    </div>

    <div class="layui-inline" id="search_date_start">
      <input class="layui-input" name="date_start" id="date_start" placeholder="挤压日期(起始)">
    </div>
    <div class="layui-inline" id="search_date_start">
      <input class="layui-input" name="date_end" id="date_end" placeholder="挤压日期(结束)">
    </div>
    ...
    layui.use(
      ...
      function() {
        ...
        var inst = table.render({
          ...
          cols: [
            [
              ...
              {
                field: 'jichu_tianbiaoren',
                title: '填表人',
                hide: true,
                edit: editable
              },
              {
                field: 'jichu_canyuren',
                title: '参与人',
                hide: true,
                edit: editable
              },
              ...
              {
                field: 'jichu_xiaojichu',
                title: '小挤压',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_jiarefangshi',
                title: '加热方式',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_cailiaowendu',
                title: '材料温度',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_baowenshijian',
                title: '保温时间',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_liaodanwendu',
                title: '料胆温度',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_mujuwendu',
                title: '模具温度',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_jichudianwendu',
                title: '挤压垫温度',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_jichukouwendu',
                title: '挤出口温度',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_qidongyali',
                title: '启动压力',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_wendingyali',
                title: '稳定压力',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_jichusudu',
                title: '挤出速度',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_liaodanguige',
                title: '料胆规格',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_mujuchukouguige',
                title: '模具出口规格',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_piliaozhenkongtuoqi',
                title: '真空脱气',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_piliaozhongliang_shuliang',
                title: '坯料重/数量',
                edit: editable,
                width: 120
              },
              {
                field: 'jichu_jichu_zhongliang',
                title: '挤出重量',
                edit: editable,
                width: 120
              },
          ...
          url: './action/table_getdata_extrude_action.php', // 后端数据接口
          page: true, // 是否显示分页
        ...
        document.getElementById('search').onclick = function() {
          var jichu_picihao = document.getElementById('jichu_picihao').value;
          var date_start = document.getElementById('date_start').value;
          var date_end = document.getElementById('date_end').value;

          table.reloadData('my_table', {
            url: './action/table_search_extrude_action.php' // 后端搜索接口
              ,
            where: {
              jichu_picihao: jichu_picihao,
        ...
        table.on('tool(my_table)', function(obj) {
          ...
          var data = obj.data;
          var php_id = data.id;
          var picihao_luhao = data.jichu_picihao;
    ...
    id: 'del',
              ...
              click: function(data, othis) {
                ...
                //根据 id 做出不同操作
                  ...
                  /* if(data.id === 'view'){
                              window.location.href = './operate/report_view_extrude.php?id='+php_id;
                            }
                              else if(data.id === 'edit'){
                              window.location.href = './operate/report_edit_extrude.php?id='+php_id;
                            }
                              else */
                  if (data.id === 'del') {
                    layer.confirm('确定删除吗?', function(index) {
                      ...
                      $.ajax({
                        url: './action/del_row_extrude.php?id=' + php_id,
                        type: 'get',
                        dataType: "json",

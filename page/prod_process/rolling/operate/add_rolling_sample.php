...
$sql = "SELECT * FROM prod_process_rolling WHERE zhazhi_picihao='$zhazhi_picihao' ORDER BY id DESC LIMIT 1";
  ...
  <form class="layui-form" action="">
    ...
    <div class="layui-form-item">
      <div class="layui-inline">
        ...
        <div class="layui-input-block">
          <input type="text" name="shiyang_bianhao" id="shiyang_bianhao" value="" placeholder="" autocomplete="off" class="layui-input">
        </div>
      </div>
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" name="daoci" placeholder="" autocomplete="off" value="1" disabled class="layui-input">
      </div>
    </div>

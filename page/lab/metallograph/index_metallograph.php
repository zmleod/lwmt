...
<body>
  ...
  <script type="text/html" id="toolbar_get_row_data">
    <a href="./operate/add_metallograph.php" class="layui-btn layui-btn-sm">新增数据</a>
    ...
    layui.use(
      ...
      function() {
        ...
        var inst = table.render({
          ...
          // },
          url: './action/table_getdata_metallograph_action.php', // 后端数据接口
          page: true, // 是否显示分页
        ...
        document.getElementById('search').onclick = function() {
          ...
          table.reloadData('my_table', {
            url: './action/table_search_metallograph_action.php', // 后端搜索接口
            where: {
              ...
              click: function(data, othis) {
                ...
                if (data.id === 'trace') {
                  ...
                  layer.open({
                    ...
                    area: ['90%', '90%'],
                    content: '../trace_lab.php?yangjian_picihao=' + trace_yangjian_picihao + '&id=' + trace_id + '&exp=metallograph_exp' // 弹出追溯
                  });
                  ...
                  layer.open({
                    ...
                    scrollbar: false, // 关闭滚动条
                    area: ['850px', '95%'],
                    content: './operate/report_view_metallograph.php?baogao_bianhao=' + edit_view_id // 弹出报告
                  });
                  ...
                  layer.open({
                    ...
                    scrollbar: false, // 关闭滚动条
                    area: ['98%', '95%'],
                    content: './operate/report_edit_metallograph.php?baogao_bianhao=' + edit_view_id // 弹出编辑窗口
                  });
                  ...
                  layer.confirm('确定删除吗?', function(index) {
                    ...
                    $.ajax({
                      url: './action/del_row_metallograph.php?id=' + del_id,
                      type: 'get',
                      dataType: "json",
                      success: function(msg) {
                        if (msg.code == 0) {

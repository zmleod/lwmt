...
$query = "SELECT * FROM neusaltspray_exp where baogao_bianhao = '$baogao_bianhao'";
// 执行查询
 ...
 <form class="layui-form"  action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input style="width: 300px;" type="text" name="baogao_bianhao" value="<?php echo $row['baogao_bianhao'];?>" placeholder="" autocomplete="off" class="layui-input" >
    </div>
  </div>
  <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <input style="width: 190px;" type="text" name="weituo_bumen" value="<?php echo $row['weituo_bumen'];?>" id="" placeholder="" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
 ...
 <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <label class="layui-form-label">试样编号</label>
       <input style="width: 100px;" type="text" value="'.$get_row['yangjian_bianhao'].'"  name="yangjian_bianhao_'.$i.'"  id="" placeholder="" autocomplete="off" class="layui-input">
    </div>
    
        <div class="layui-inline">
      <label class="layui-form-label">试验时间</label>
      <input style="width: 100px;" type="text" value="'.$get_row['shiyan_shijian'].'" name="shiyan_shijian_'.$i.'" placeholder="" autocomplete="off" class="layui-input">
    </div>
    
    
           <div class="layui-inline">
      <label class="layui-form-label">腐蚀前质量(g)</label>
      <input style="width: 100px;" type="text" value="'.$get_row['zhongliang_fushiqian'].'" name="zhongliang_fushiqian_'.$i.'" placeholder="" autocomplete="off" class="layui-input">
    </div>
    
    
              <div class="layui-inline">
      <label class="layui-form-label">去除腐蚀产物质量(g)</label>
      <input style="width: 100px;" type="text" value="'.$get_row['zhongliang_fushihou'].'" name="zhongliang_fushihou_'.$i.'" placeholder="" autocomplete="off" class="layui-input">
    </div>
...
form.on('submit(demo1)', function(data){
	...
	$.post('../action/report_edit_neusaltspray_action.php', JSON.stringify(data.field), function(res){
      // 处理PHP脚本返回的结果
      if(res.code=='0'){
            alert("数据编辑成功");

...
<form class="layui-form"  action="">
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      ...
      <input style="width: 190px;" type="text" name="yangjian_shuliang" id="yangjian_shuliang" placeholder="" autocomplete="off" class="layui-input">
    </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <input style="width: 200px;" type="text" name="shiyan_shebei" id="" placeholder="" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
      <label class="layui-form-label">试验条件</label>
      <input style="width: 200px;" type="text" name="shiyan_tiaojian" id="" placeholder="" autocomplete="off" class="layui-input">
    </div>
  </div>
 ...
 <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input style="width: 515px;" type="text" value="GB/T 10125 2021 人造气氛腐蚀试验盐雾试验"  name="shiyan_biaozhun" placeholder="" autocomplete="off" class="layui-input" >
    </div>
  </div>
   ...
   <div  class="layui-form-item">
    ...
    <div class="layui-inline">
     ...
     <div class="layui-inline">
      ...
      <input style="width: 100px;" type="text" name="shiyan_shijian_1" id="" placeholder="测试时间(h)" autocomplete="off" class="layui-input">
    </div>

     <div class="layui-inline">
      
      <input style="width: 100px;" type="text" name="zhongliang_fushiqian_1" id="" placeholder="腐蚀前质量(g)" autocomplete="off" class="layui-input">
    </div>
           
     <div class="layui-inline">
     
      <input style="width: 100px;" type="text" name="zhongliang_fushihou_1" id="" placeholder="去除腐蚀产物质量(g)" autocomplete="off" class="layui-input">
    </div>
     
     <div class="layui-inline">
     
      <input style="width: 100px;" type="text" name="shizhongliang_1" id="" placeholder="失重量" autocomplete="off" class="layui-input">
    </div>
    ...
    <div class="layui-inline">
      ...
      <input style="width: 300px;" type="text" name="beizhu_1" id="beizhu_1" placeholder="备注" autocomplete="off" class="layui-input">
    </div>
  </div> 
...
form.on('submit(demo1)', function(data){
	...
	$.post('../action/add_neusaltspray_action.php', JSON.stringify(data.field), function(res){
      // 处理PHP脚本返回的结果
      if(res.code=='0'){
            alert("数据新增成功");
            window.location.href = "./report_img_upload_neusaltspray.php?baogao_bianhao="+php_baogao_bianhao;
        }
    }, 'json');
...
document.getElementById('addElements').addEventListener('click', function() {
 ...
 var input6 = document.createElement('input');
  ...
  input7.type = 'text';
  input7.name= 'shiyan_shijian_'+count;

...
<body>
  ...
  <script type="text/html" id="toolbar_get_row_data">
    <a href="./operate/add_neusaltspray.php" class="layui-btn layui-btn-sm">新增数据</a>
      ...
      function() {
        ...
        var inst = table.render({
          ...
          cols: [
            [
              ...
              {
                field: 'zhongliang_fushiqian',
                title: '腐蚀前<br> (g)',
                edit: editable,
                width: 100
              },
              {
                field: 'zhongliang_fushihou',
                title: '腐蚀后<br> (g)',
                edit: editable,
                width: 100
              },
              ...
              {
                field: 'shiyan_shijian',
                title: '试验时间<br> (h)',
                edit: editable,
                width: 100
              },
              {
                field: 'pingjun_fushi_sulv',
                title: '腐蚀速率平均值<br> (mg/cm2/day)',
                edit: editable,
                width: 140
              },
              {
          ...
          // },
          url: './action/table_getdata_neusaltspray_action.php', // 后端数据接口
          page: true, // 是否显示分页
        ...
        document.getElementById('search').onclick = function() {
          ...
          table.reloadData('my_table', {
            url: './action/table_search_neusaltspray_action.php', // 后端搜索接口
            where: {
              ...
              click: function(data, othis) {
                ...
                if (data.id === 'trace') {
                  ...
                  layer.open({
                    ...
                    area: ['90%', '90%'],
                    content: '../trace_lab.php?yangjian_picihao=' + trace_yangjian_picihao + '&id=' + trace_id + '&exp=neusaltspray_exp' // 弹出追溯
                  });
                  ...
                  layer.open({
                    ...
                    scrollbar: false, // 关闭滚动条
                    area: ['850px', '95%'],
                    content: './operate/report_view_neusaltspray.php?baogao_bianhao=' + edit_view_id // 弹出报告
                  });
                  ...
                  layer.open({
                    ...
                    scrollbar: false, // 关闭滚动条
                    area: ['98%', '95%'],
                    content: './operate/report_edit_neusaltspray.php?baogao_bianhao=' + edit_view_id // 弹出编辑窗口
                  });
                  ...
                  layer.confirm('确定删除吗?', function(index) {
                    ...
                    $.ajax({
                      url: './action/del_row_neusaltspray.php?id=' + del_id,
                      type: 'get',
                      dataType: "json",
                      success: function(msg) {
                        if (msg.code == 0) {

...
<fieldset class="layui-elem-field layui-field-title">
  <legend>化学成分-查看数据</legend>
</fieldset>
   <a href="../index_chemcompo.php" class="layui-btn layui-btn-sm">返回</a>
<form class="layui-form"  action="">
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      ...
      <a href="./report_edit_chemcompo.php?id=<?php echo $row["id"];?>" class="layui-btn layui-btn-sm">修改</a>
</form>

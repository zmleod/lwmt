  ...
  <input type="text" name="project_id" value="<?php echo $project_id = $_GET['project_id']; ?>" hidden="true">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline layui-input-wrap">
        ...
        <input type="text" name="plan_start_date" id="plan_start_date" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
      </div>
  ...
  <script>
    layui.use(function() {
      ...
      form.on('submit(demo1)', function(data) {
        ...
        // 显示填写结果，仅作演示用
        $.post('../action/add_plan_action.php', JSON.stringify(data.field), function(res) {
          // 处理PHP脚本返回的结果
          if (res.code == '0') {
            alert("计划增加成功");

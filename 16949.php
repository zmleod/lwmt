...
<div class="container">
    ...
    <script>
        ...
        var students = ["侯晓旭", "刘乙霖", "刘秋红", "叶沛然", "袁方", "郑书", "毛艳梅", "杨杭苇", "孟祥龙"];
        ...
        startStopBtn.onclick = function() {
            if (!flag) {
                ...
                flag = true;
                startStopBtn.innerHTML = "停止";
                // 启动定时器，每5ms随机选取一个名字显示
                timer = setInterval(pickRandomName, 5);
            } else {
                // 将标志变量置为false，表示停止点名
                flag = false;
                startStopBtn.innerHTML = "开始";
                // 清除定时器，停止随机选取名字
                clearInterval(timer);
            }
        };
